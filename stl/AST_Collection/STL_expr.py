...
from stl.AST_Collection.core_AST import STL_Expr
from stl.AST_Collection.val import Meta_Id_Val
...
class G_STL_Expr(Unary_STL_Expr):
    ...
    def eval(self, eval_context):
        ...
        eval_context.add(Meta_Id_Val("$this"), self.signal_val.slice_signal_by_time_interval(offset_begin_expr_int, offset_end_expr_int))
...
class X_STL_Expr(Unary_STL_Expr):
    ...
    def eval(self, eval_context):
        ...
        # print("slice begin: " + str(offset_begin_expr_int))
        # print("slide end: " + str(offset_end_expr_int))
        eval_context.add(Meta_Id_Val("$this"), self.signal_val.slice_signal_by_time_interval(offset_time_interval_int, offset_time_interval_int))
